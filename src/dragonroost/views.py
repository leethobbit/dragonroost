...
class HomeListView(LoginRequiredMixin, PageTitleViewMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["donation_total_365_days"] = Animal.objects.filter(outcome_date__gte=(datetime.datetime.now() - datetime.timedelta(days=(365)))).aggregate(Sum('donation_fee'))['donation_fee__sum']
