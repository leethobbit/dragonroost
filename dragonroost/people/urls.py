...
from dragonroost.people.views import PersonTableSearchView
...
urlpatterns = [
    ...
    path("table/", PersonHTMxView.as_view(), name="person-table"),
    path("table/search/", PersonTableSearchView.as_view(), name="get-person-list"),
]
