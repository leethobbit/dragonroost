...
from dragonroost.animals.views import AnimalTableView
...
urlpatterns = [
    ...
    path("table/", AnimalTableView.as_view(), name="animal-table"),
    path("table/search/", AnimalTableSearchView.as_view(), name="get-animal-list"),
